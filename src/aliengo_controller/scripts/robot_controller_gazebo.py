...
command_topics = ["/quadruped_controller/FR_hip_joint/command",
                  "/quadruped_controller/FR_thigh_joint/command",
                  "/quadruped_controller/FR_calf_joint/command",
                  "/quadruped_controller/FL_hip_joint/command",
                  "/quadruped_controller/FL_thigh_joint/command",
                  "/quadruped_controller/FL_calf_joint/command",
                  "/quadruped_controller/RR_hip_joint/command",
                  "/quadruped_controller/RR_thigh_joint/command",
                  "/quadruped_controller/RR_calf_joint/command",
                  "/quadruped_controller/RL_hip_joint/command",
                  "/quadruped_controller/RL_thigh_joint/command",
                  "/quadruped_controller/RL_calf_joint/command"]
